...
class CostQuery extends _Executable.default {
  ...
  async _beforeExecute(client) {
    ...
    this._header = {
      payment: await (0, _Query._makePaymentTransaction)(_TransactionId.default.generate(new _AccountId.default(0)), new _AccountId.default(0), operator, new _Hbar.default(0)),
  ...
  _mapResponse(response, nodeAccountId, request) {
    ...
    return Promise.resolve(_Hbar.default.fromTinybars(cost));
  }
  /**
   * @override
   * @internal
