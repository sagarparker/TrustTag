...
class TokenInfo {
  ...
  static _fromProtobuf(info) {
    ...
    return new TokenInfo({
      tokenId: _TokenId.default._fromProtobuf(info.tokenId),
      name: info.name,
      symbol: info.symbol,
      decimals: info.decimals,
      totalSupply: _long.default.fromValue(info.totalSupply),
      treasuryAccountId: info.treasury != null ? _AccountId.default._fromProtobuf(info.treasury) : null,
      ...
      autoRenewPeriod: info.autoRenewPeriod != null ? _Duration.default._fromProtobuf(info.autoRenewPeriod) : null,
      expirationTime: info.expiry != null ? _Timestamp.default._fromProtobuf(info.expiry) : null,
