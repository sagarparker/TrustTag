...
class NetworkVersionInfo {
  ...
  static _fromProtobuf(info) {
    return new NetworkVersionInfo({
      protobufVersion: _SemanticVersion.default._fromProtobuf(info.hapiProtoVersion),
      servicesVesion: _SemanticVersion.default._fromProtobuf(info.hederaServicesVersion)
    });
  }
  /**
   * @internal
