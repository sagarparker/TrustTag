...
class ContractUpdateTransaction extends _Transaction.default {
  ...
  static _fromProtobuf(transactions, signedTransactions, transactionIds, nodeIds, bodies) {
    const body = bodies[0];
    const update = body.contractUpdateInstance;
    return _Transaction.default._fromProtobufTransactions(new ContractUpdateTransaction({
      contractId: update.contractID != null ? _ContractId.default._fromProtobuf(update.contractID) : undefined,
      bytecodeFileId: update.fileID != null ? _FileId.default._fromProtobuf(update.fileID) : undefined,
      ...
      proxyAccountId: update.proxyAccountID != null ? _AccountId.default._fromProtobuf(update.proxyAccountID) : undefined,
