...
class ContractCreateTransaction extends _Transaction.default {
  ...
  static _fromProtobuf(transactions, signedTransactions, transactionIds, nodeIds, bodies) {
    ...
    return _Transaction.default._fromProtobufTransactions(new ContractCreateTransaction({
      bytecodeFileId: create.fileID != null ? _FileId.default._fromProtobuf(create.fileID) : undefined,
      ...
      proxyAccountId: create.proxyAccountID != null ? _AccountId.default._fromProtobuf(create.proxyAccountID) : undefined,
