...
class FileAppendTransaction extends _Transaction.default {
  ...
  static _fromProtobuf(transactions, signedTransactions, transactionIds, nodeIds, bodies) {
    ...
    return _Transaction.default._fromProtobufTransactions(new FileAppendTransaction({
      fileId: append.fileID != null ? _FileId.default._fromProtobuf(append.fileID) : undefined,
      contents: contents
  ...
  freezeWith(client) {
    ...
    for (let chunk = 0; chunk < chunks; chunk++) {
      ...
      nextTransactionId = new _TransactionId.default(nextTransactionId.accountId, new _Timestamp.default(
      /** @type {Timestamp} */
