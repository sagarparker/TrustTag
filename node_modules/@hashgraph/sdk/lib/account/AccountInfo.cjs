...
class AccountInfo {
  ...
  static _fromProtobuf(info) {
    return new AccountInfo({
      ...
      expirationTime: _Timestamp.default._fromProtobuf(info.expirationTime),
      autoRenewPeriod: info.autoRenewPeriod != null ? new _Duration.default(info.autoRenewPeriod.seconds) : new _Duration.default(0),
      proxyAccountId: info.proxyAccountID != null && _long.default.fromValue(info.proxyAccountID.shardNum).toInt() !== 0 && _long.default.fromValue(info.proxyAccountID.realmNum).toInt() !== 0 && _long.default.fromValue(info.proxyAccountID.accountNum).toInt() !== 0 ? _AccountId.default._fromProtobuf(info.proxyAccountID) : null,
