...
class AccountDeleteTransaction extends _Transaction.default {
  ...
  static _fromProtobuf(transactions, signedTransactions, transactionIds, nodeIds, bodies) {
    ...
    return _Transaction.default._fromProtobufTransactions(new AccountDeleteTransaction({
      accountId: accountDelete.deleteAccountID != null ? _AccountId.default._fromProtobuf(accountDelete.deleteAccountID) : undefined,
      transferAccountId: accountDelete.transferAccountID != null ? _AccountId.default._fromProtobuf(accountDelete.transferAccountID) : undefined
