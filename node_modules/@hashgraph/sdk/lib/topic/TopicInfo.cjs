...
class TopicInfo {
  ...
  static _fromProtobuf(infoResponse) {
    ...
    return new TopicInfo({
      topicId: _TopicId.default._fromProtobuf(infoResponse.topicID),
      ...
      autoRenewPeriod: info.autoRenewPeriod != null ? new _Duration.default(info.autoRenewPeriod.seconds) : null,
  ...
  toBytes() {
    return proto.ConsensusTopicInfo.encode(this._toProtobuf().topicInfo).finish();
  }
