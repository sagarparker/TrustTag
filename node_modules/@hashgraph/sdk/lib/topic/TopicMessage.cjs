...
class TopicMessage {
  ...
  static _ofSingle(response) {
    return new TopicMessage({
      consensusTimestamp: _Timestamp.default._fromProtobuf(response.consensusTimestamp),
  ...
  static _ofMany(responses) {
    ...
    const consensusTimestamp = _Timestamp.default._fromProtobuf(last.consensusTimestamp);
