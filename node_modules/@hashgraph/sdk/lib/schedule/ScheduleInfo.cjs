...
class ScheduleInfo {
  ...
  static _fromProtobuf(info) {
    return new ScheduleInfo({
      scheduleId: _ScheduleId.default._fromProtobuf(info.scheduleID),
      creatorAccountID: info.creatorAccountID != null ? _AccountId.default._fromProtobuf(info.creatorAccountID) : null,
      payerAccountID: info.payerAccountID != null ? _AccountId.default._fromProtobuf(info.payerAccountID) : null,
      ...
      executed: info.executionTime != null ? _Timestamp.default._fromProtobuf(info.executionTime) : null,
      deleted: info.deletionTime != null ? _Timestamp.default._fromProtobuf(info.deletionTime) : null,
